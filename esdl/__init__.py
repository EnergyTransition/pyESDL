...
Carrier.profile.eType = GenericProfile
...
MeasureGroup.measureGroup.eType = MeasureGroup
MeasureGroup.measure.eType = Measure
MeasureGroupReference.reference.eType = MeasureGroup
